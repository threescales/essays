...
class App extends React.Component<any, any> {
  ...
  componentWillMount() {
    this.props.dispatch(
      ArticleAction.getArticleById(this.props.match.params.articleId)
    );
  }

  componentDidMount() {
    this.props.dispatch(
      ArticleAction.updateArticleCount(
        this.props.match.params.articleId,
        "read"
      )
    );
    this.props.dispatch(
      ArticleAction.getAllComments(this.props.match.params.articleId)
    );
    // initPosition()
  }
      ...
      <div className="animated fadeInLeft">
        ...
        <section
          ...
          className={classnames({
            init: true,
            "init--moveLeft": this.props.show.toJS().catalogue
          })}
        >
          {!!editorState ? (
            <Editor
