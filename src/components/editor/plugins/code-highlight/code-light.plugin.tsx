...
const WS = /\s+/g;
const BACK_SLASH = /\//g;
const mapFileExtensionToLanguage = (name: string) =>
  FILE_EXTENSION_MAP[name] ? FILE_EXTENSION_MAP[name] : name;
...
export const codeHighLightPlugin: EditorPluginBuilder<PluginConfig, Method> = (
  ...args
) => {
  let currentSyntax;
