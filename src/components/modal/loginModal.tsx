            ...
            <div>
                <Modal isOpen={this.props.show} contentLabel="登录/注册" close={this.closeModal}>
                    <div className="login-signup-modal">
                        <div className="tabs">
                            <a className={classnames({'selected-tab':this.state.tabIndex==0})} onClick={()=> this.toggleTab(0)}>登录</a>
                            <a className={classnames({'selected-tab':this.state.tabIndex==1})} onClick={()=> this.toggleTab(1)}>注册</a>
                        </div>
